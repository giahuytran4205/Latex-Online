    ...
    useEffect(() => {
        ...
        const handleWheel = (e) => {
            if (e.ctrlKey || e.metaKey) {
                ...
                setScale(s => Math.round(Math.max(0.2, Math.min(5, s + delta)) * 10) / 10)
            }
        }
            ...
            <div className="preview-panel__toolbar">
                <div className="toolbar-left">
                    ...
                    <div className="page-navigation">
                        <button className="toolbar-btn" onClick={() => scrollToPage(currentPage - 1)} disabled={currentPage <= 1}>
                        ...
                        <button className="toolbar-btn" onClick={() => scrollToPage(currentPage + 1)} disabled={currentPage >= numPages}>
                            ...
                            loading={
                                <div className="preview-loading">
                                    <div className="loading-document">
                                        <svg className="loading-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                                            <polyline points="14 2 14 8 20 8"></polyline>
